...
public class LogoutPayload {
  @JsonProperty("islogout")
  private String islogout = null;

  public LogoutPayload islogout(String islogout) {
    this.islogout = islogout;
    return this;
  }

   /**
   * Required for validate the logout details .
   * @return islogout
  **/
  @ApiModelProperty(example = "true", value = "Required for validate the logout details .")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    LogoutPayload logoutPayload = (LogoutPayload) o;
    return Objects.equals(this.islogout, logoutPayload.islogout);
  }
  ...
  public String toString() {
    ...
    sb.append("class LogoutPayload {\n");
    
    sb.append("    islogout: ").append(toIndentedString(islogout)).append("\n");
    sb.append("}");
    return sb.toString();
  }
